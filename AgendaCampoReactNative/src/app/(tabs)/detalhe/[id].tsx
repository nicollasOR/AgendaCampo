...
import { useVisitaDetalhes } from "../../../hooks/useVisitaDetalhe";
        ...
        >
          <View style={Column}>
            ...
            <View style={Row}>
              ...
              <Text style={[P, { color: Colors.gray }]}>{formatarData(visita?.dataInicio)}</Text>
            </View>
          </View>
          <View style={Line} />
      ...
      <View style={Row}>
        ...
        <Text style={P}>Email: {varAux.email}</Text>
            ...
            <View style={[H3, { flexDirection: "column" }]}>
              ...
              <Text style={P}>{visita?.logradouro} - {visita?.bairro} - {visita?.cep}</Text>
            </View>
          </View>
          ...
          <View style={[Center, Card, Column]}>
            ...
            <TouchableOpacity style={Btn} onPress={() => router.replace("../reagendar/" + id)}>
